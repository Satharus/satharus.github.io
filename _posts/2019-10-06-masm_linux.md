...
lick on the gear icon that says “Configure” in the main PlayOnLinux interface.
...
You may also notice that if the output in the console gets too big you lost the lines at the top. To make the console scrollable and give it a larger buffer size do the following:
