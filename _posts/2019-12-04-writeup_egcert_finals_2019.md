...
![score](/assets/images/writeup-national-ctf-2019/score.png)
...
{: style="text-align:center"}
![text](/assets/images/writeup-national-ctf-2019/text.png)
...
{: style="text-align:center"}
![text 1](/assets/images/writeup-national-ctf-2019/text-1.png)
...
{: style="text-align:center"}
![text 2](/assets/images/writeup-national-ctf-2019/text-2.png)
...
{: style="text-align:center"}
![t9](/assets/images/writeup-national-ctf-2019/t9.png)
...
{: style="text-align:center"}
![text 3](/assets/images/writeup-national-ctf-2019/text-3.png)
...
{: style="text-align:center"}
![initial-test](/assets/images/writeup-national-ctf-2019/initial-test.png)

At this point we had no idea what to brute force, so they released this hint for everyone.

{: style="text-align:center"}
![hint](/assets/images/writeup-national-ctf-2019/hint.png)
...
{: style="text-align:center"}
![getting-digitstext](/assets/images/writeup-national-ctf-2019/getting-digitstext.png)

Repeating this for every digit, we got ourselves the flag!

{: style="text-align:center"}
![final flag](/assets/images/writeup-national-ctf-2019/final-flag.png)
...
{: style="text-align:center"}
![text 4](/assets/images/writeup-national-ctf-2019/text-4.png)
...
{: style="text-align:center"}
![no args](/assets/images/writeup-national-ctf-2019/noargs.png)

Doesn’t seem to do anything interesting, let’s take a look under the hood.

{: style="text-align:center"}
![mainclass](/assets/images/writeup-national-ctf-2019/mainclass.png)

{: style="text-align:center"}
![ciphertext](/assets/images/writeup-national-ctf-2019/ciphertext.png)

{: style="text-align:center"}
![encrypt class](/assets/images/writeup-national-ctf-2019/encryptclass.png)
...
{: style="text-align:center"}
![arg func](/assets/images/writeup-national-ctf-2019/argfunc.png)

This part is interesting enough, the program apparently needs 4 arguments to execute properly. Let’s try that.

{: style="text-align:center"}
![4args-1](/assets/images/writeup-national-ctf-2019/4args-1.png)
...
{: style="text-align:center"}
![cleanprogram](/assets/images/writeup-national-ctf-2019/cleanprogram.png)
...
{: style="text-align:center"}
![debug](/assets/images/writeup-national-ctf-2019/debug.png)
...
{: style="text-align:center"}
![decoded code](/assets/images/writeup-national-ctf-2019/decoded-code.png)
...
{: style="text-align:center"}
![initial powershell](/assets/images/writeup-national-ctf-2019/initial-powershell.png)
...
{: style="text-align:center"}
![second powershell](/assets/images/writeup-national-ctf-2019/second-powershell.png)

And Again.

{: style="text-align:center"}
![third powershell](/assets/images/writeup-national-ctf-2019/third-powershell.png)
...
{: style="text-align:center"}
![final powershell](/assets/images/writeup-national-ctf-2019/final-powershell.png)
...
{: style="text-align:center"}
![cleaned file](/assets/images/writeup-national-ctf-2019/cleanedfile.png)

`cat flagCode.ps  | tr {} '\n' | cut -d \' -f 2 | tr -d '\n' | tr -d ' '`

{: style="text-align:center"}
![finalcommand](/assets/images/writeup-national-ctf-2019/finalcommand.png)
